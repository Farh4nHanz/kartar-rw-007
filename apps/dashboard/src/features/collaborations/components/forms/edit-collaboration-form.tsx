...
import { updateCollaborationByIdMutationOptions } from "@/features/collaborations/hooks/mutation-options";
...
export const EditCollaborationForm = memo(
	({
		selectedData,
		categories,
		periods,
		...
		const { mutateAsync } = useMutation(
			updateCollaborationByIdMutationOptions(selectedData.id),
		);

		const form = useAppForm({
			formId: "edit-collaboration-form",
			defaultValues: {
				partner_name: selectedData.partner_name,
				description: selectedData.description,
				category_id: selectedData.category.id,
				period_id: selectedData.period.id,
				logo: undefined,
